...
/***/ "./src/js/modules/checkEmailInput.js":
/*!*******************************************!*\
  !*** ./src/js/modules/checkEmailInput.js ***!
  \*******************************************/
...
function checkEmailInput(inputSelector) {
  var emailInput = document.querySelectorAll(inputSelector);
...
/* harmony default export */ __webpack_exports__["default"] = (checkEmailInput);

/***/ }),

/***/ "./src/js/modules/checkNameInput.js":
/*!******************************************!*\
  !*** ./src/js/modules/checkNameInput.js ***!
  \******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
function checkNameInput(inputSelector) {
  var nameInput = document.querySelectorAll(inputSelector);
...
/* harmony default export */ __webpack_exports__["default"] = (checkNameInput);
...
function form(orderData) {
  ...
  var showStatusMessage = function showStatusMessage(title, descr, element) {
    var messageTitle = messageWindow.querySelector('.modal__subtitle'),
        messageDescr = messageWindow.querySelector('.modal__descr');
    windows.forEach(function (item) {
      (0,_modals__WEBPACK_IMPORTED_MODULE_5__.closeModal)(item);
    });
    messageTitle.textContent = title;
    messageDescr.textContent = descr;
    (0,_modals__WEBPACK_IMPORTED_MODULE_5__.openModal)(element);
  };
  ...
  forms.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      postData('php/server.php', formData).then(function (res) {
        console.log(res);
...
function openModal(elem) {
  ...
  try {
    document.querySelector('.pageup').style.marginRight = "".concat(calcScrollWidth(), "px");
  } catch (err) {}
}
...
function order(orderData) {
  var products = document.querySelectorAll('.catalog-item__subtitle'),
...
function phoneMask(inputSelector) {
  var phoneInput = document.querySelectorAll(inputSelector);
...
function reviews(reviewSelector) {
  var review = document.querySelectorAll(reviewSelector);
  window.addEventListener('scroll', function () {
    review.forEach(function (item) {
      if (Math.round(item.getBoundingClientRect().top) <= 650) {
        item.classList.add('animate__animated', 'animate__fadeInUp'); // for IE

        item.style.opacity = '1';
      } else if (Math.round(item.getBoundingClientRect().top) > 650) {
        item.classList.remove('animate__fadeInUp'); // for IE
...
/* harmony import */ var _modules_showDetails__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/showDetails */ "./src/js/modules/showDetails.js");
...
/* harmony import */ var _modules_order__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/order */ "./src/js/modules/order.js");
/* harmony import */ var _modules_checkNameInput__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/checkNameInput */ "./src/js/modules/checkNameInput.js");
/* harmony import */ var _modules_checkEmailInput__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/checkEmailInput */ "./src/js/modules/checkEmailInput.js");
...
/* harmony import */ var _modules_reviews__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/reviews */ "./src/js/modules/reviews.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.catalog__tabs', '.catalog__tab', '.catalog__content', 'catalog__tab_active');
  (0,_modules_showDetails__WEBPACK_IMPORTED_MODULE_3__["default"])('.catalog-item__link', '.catalog-item__back', '.catalog-item__content', '.catalog-item__details');
  (0,_modules_slider__WEBPACK_IMPORTED_MODULE_4__["default"])('.slider__wrapper', '.slider__body', '.slider__inner', '.slider__item', '.arrow_prev', '.arrow_next');
  (0,_modules_form__WEBPACK_IMPORTED_MODULE_5__["default"])(orderInfo);
  (0,_modules_order__WEBPACK_IMPORTED_MODULE_6__["default"])(orderInfo);
  (0,_modules_checkNameInput__WEBPACK_IMPORTED_MODULE_7__["default"])('[name="name"]');
  (0,_modules_checkEmailInput__WEBPACK_IMPORTED_MODULE_8__["default"])('[name="email"]');
  (0,_modules_scroll__WEBPACK_IMPORTED_MODULE_9__["default"])('.pageup');
  (0,_modules_phoneMask__WEBPACK_IMPORTED_MODULE_10__["default"])('[name="phone"]');
  (0,_modules_reviews__WEBPACK_IMPORTED_MODULE_11__["default"])('.reviews-item');
});
}();
/******/ })()
;
