...
function showDetails(linkSelector, linkBackSelector, itemContentSelector, itemDetailsSelector) {
  ...
  linkBack.forEach(function (item, i) {
    item.addEventListener('click', function (e) {
      e.preventDefault();
...
function slider(wrapperSelector, wrapperInnerSelector, slideSelector, prevBtnSelector, nextBtnSelector) {
  var slidesWrapper = document.querySelector(wrapperSelector),
  ...
  var offset = 0;
  slidesWrapperInner.style.width = "".concat(100 * slideItem.length, "%");
  slidesWrapperInner.style.display = 'flex';
  slidesWrapperInner.style.transition = '0.5s all';
  slidesWrapper.style.overflow = 'hidden';
  slideItem.forEach(function (item) {
    item.style.width = "".concat(sliderWidth, "px");
  });

  function moveSlide(value) {
    slidesWrapperInner.style.transform = "translateX(-".concat(value, "px)");
  }
...
function tabs(tabParentSelector, tabHeaderSelector, tabContentSelector, activeClass) {
  var tabHeadersParent = document.querySelector(tabParentSelector),
...
/* harmony import */ var _modules_showDetails__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/showDetails */ "./src/js/modules/showDetails.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_slider__WEBPACK_IMPORTED_MODULE_3__["default"])('.slider__body', '.slider__inner', '.slider__item', '.arrow_prev', '.arrow_next');
});
}();
/******/ })()
;
